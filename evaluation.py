...
from Preprocessing import Vocabulary, get_loader
...
eval_data_loader = get_loader(image_dir, sis_path, vocab, transform, args.batch_size, shuffle=False, num_workers=args.num_workers)
...
# initialise the result with an empty list
results = []
total_step = len(eval_data_loader)
avg_loss = 0.0
for bi, (image_stories, targets_set, lengths_set, photo_sequence_set, album_ids_set) in enumerate(eval_data_loader):
    loss = 0
...
output = {}
output["team_name"] = "ADL_Prakhar_Shobhit"
